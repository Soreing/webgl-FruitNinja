function PineappleBehaviour(eng, game)
{
	...
	this.radius     = 25.0,		//Radius of the sphere that defines the fruit's volume
	...
	{
		var script = new PineappleBehaviour(this.engine, this.game);
	...
	{	
		...
		piece.name   = "Pineapple Bottom";
		piece.parent = this.object;
		piece.noHide = true;
		piece.mesh   = new PineappleBottom(this.engine.webGL);
		...
		piece.material.textured  = 5;
		piece.rigidbody.verDrag  = 0;
		piece.transform.PivotTranslate( new Vector3(0.0,-6.0,0.0) );
		piece.Instantiate();
		this.fruits.push(piece);
		
		piece        = new GraphicsObject(this.engine);
		piece.name   = "Pineapple Top";
		piece.parent = this.object;
		piece.noHide = true;
		piece.mesh   = new PineappleTop(this.engine.webGL);
		piece.material.ambient   = new Color(0.5,0.5,0.5,1.0);
		piece.material.diffuse   = new Color(1.0,1.0,1.0,1.0);
		piece.material.shininess = 10;
		piece.material.textured  = 5;
		piece.rigidbody.verDrag  = 0;
		piece.transform.PivotTranslate( new Vector3(0.0,13.0,0.0) );
		piece.Instantiate();
		this.fruits.push(piece);
