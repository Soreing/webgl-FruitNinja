function RestartBehaviour(eng)
{
	this.engine = eng,	//Reference to the Engine object
	this.object = 0,	//Reference to the Graphics Object object
	
	this.width  = 2.0;	//Width of the object used for click detection		
	this.height = 2.0;	//Height of the object used for click detection
				...
				{	switch (scr.engine.objects[i].name)
					{
						...
						case "Game Over"     :
						case "Instruction2"  :
						case "QuitButton"    : scr.engine.objects[i].Disable(); break;
						case "Instruction1"  :
						case "PauseButton"   : scr.engine.objects[i].Enable(); break;
						case "Score"         : scr.engine.objects[i].mesh.SetNumber(0); break;
						case "HighScore"     : scr.engine.objects[i].material.color = new Color(1.0,1.0,0.2,1.0); break;
						case "Health1"       : 
						case "Health2"       : 
						case "Health3"       : scr.engine.objects[i].mesh.SetHealth(true); break;
						case "Mouse Cursor"  : break;
						case "Mouse Trail"   : break;
						case "SkyBox"        : break;
						case "Game Manager"  : scr.engine.objects[i].scripts[0].Start(); break;
						default : scr.engine.objects[i].Destroy(); i--; break;
				}	}
